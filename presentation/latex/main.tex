...
\begin{frame}{Key Assumptions}
  \centering
  \includegraphics[width=0.9\textwidth]{\figures dag.png}
\end{frame}

\begin{frame}{Key Assumptions}
  \centering
  \includegraphics[width=0.9\textwidth]{\figures dag-cont.png}
\end{frame}

\begin{frame}{Possible Violations}
  \centering
  \includegraphics[width=0.9\textwidth]{\figures dag-crit.png}
\end{frame}
